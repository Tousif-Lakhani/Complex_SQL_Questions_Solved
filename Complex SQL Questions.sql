...
(1, 'Microsoft', 'developer', '2020-04-13', '2021-11-01'),(1, 'Google', 'developer', '2021-11-01', NULL),
...
SELECT 
	*,
    LAG(employer) OVER (PARTITION BY user_id ORDER BY user_id, start_date DESC) AS Next_Employer
FROM linkedin_users)
